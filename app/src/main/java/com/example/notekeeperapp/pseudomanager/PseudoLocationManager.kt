package com.example.notekeeperapp.pseudomanager
...
class PseudoLocationManager(private val context: Context, private val callback: (Double, Double) -> Unit) : Runnable {
    ...
    /**Companion Object is primarily used to define class level variables and methods called static variables. This is common across all instances of the class*/
    companion object {
